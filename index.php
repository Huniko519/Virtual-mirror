...
<html class="no-js">
    ...
    <head>
        ...
        <script>window.html5 || document.write('<script
        src="js/vendor/html5shiv.js"><\/script>')</script> <![endif]-->
    ...
    <body>
        ...
        <div class="products-list">
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-1.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-2.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-3.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-4.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-5.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-6.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-7.png');">Try in Mirror</a>
                </div>
            </div>
            ...
            <div class="the-product">
                ...
                <div class="product-buttons">
                    <a
                        href="#"
                        onclick="javascript:return try_mirror('frames/transparent-frames/frame-8.png');">Try in Mirror</a>
                </div>
            </div>
        ...
        <?php include 'virtual_mirror.php'; ?>
        <!-- main Tool loaded here -->
    </body>
</html>